...
<title>Admin New Releases</title>
							...
							<tr id="links">
								...
								<td colspan="4" id="horizontal">
									...
									<ul>
										...
										<li><a href="UserController?action=listAllProducts">SHOP</a></li>
							...
							<tr>
								...
								<form action="UserController" method="post">
									<table align="center"  border="0" cellspacing="0" width="90%">
										...
										<caption><h1> New Releases </h1></caption>
													...
													<td>
														...
														<table align="left" width="90%">
															...
															<tr>
																...
																<th id="reg" align="left" bgcolor="#CCCCCC" width="20%"><label for="username"></label></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="12%"><label></label></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="27%"><label></label></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="16%"><label></label></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="14%"><label></label></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="14%"><a href="UserController?action=sortByPrice"><label></label></a></th>
														...
														<form action="UserController" method="post">
															...
															<table frame="box" align="center" width="100%">
																...
																<tr>
																	...
																	<td id="reg" align="center"><input type="hidden" name="desc" value="<%=p.getDescription()%>"/></td>
																	<td id="reg" align="center"><input type="hidden" name="cover" value="<%=p.getCover()%>"/></td>
																	<td id="reg" align="center"><input type="hidden" name="action" value="insertAlbum"/></td>
																	<td id="reg" align="center"><input type="submit" name="Add To Shop" value="Add To Shop"/></td>
																	<!-- <td id="reg" align="center"><a href="UserController?action=insertAlbum&code=<%=p.getCode()%>&cover=<%=p.getCover()%>&genre=<%=p.getGenre()%>&desc=<%=p.getDescription()%>&price=<%=p.getPrice()%>&name=<%=p.getName()%>">Add To Shop</a></td> -->
																</tr>

												...
												<tr>
													...
													<td>
															...
															<table id="reg" frame="box" align="center" width="90%">
																...
																<tr bgcolor="#CC9933"> 
																	<th colspan="4" align="center"><label><fmt:message key="login.label.deleteprofile" /></label></th>
																<tr>
																...
																<tr>
																	...
																	<td id="reg" align="center"><input type="text" readonly="readonly" name="firstname" value="${user.firstName}"></td>
																	<td id="reg" align="center"><input type="text" readonly="readonly" name="lastname" value="${user.lastName}"></td>
																	<td id="reg" align="center"><input type="text" readonly="readonly" name="username" value="${user.userName}"></td>
																	<td id="reg" align="center"><input type="text" readonly="readonly" name="email" value="${user.emailAddress}"></td>
																	<td id="reg" align="center"><input type="hidden" name="action" value="delete"></td>
																	<td id="reg" align="center"><input type="submit" value="<fmt:message key="login.button.delete"/>"></td>

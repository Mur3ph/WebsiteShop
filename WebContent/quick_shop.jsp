							...
							<tr>
								...
								<form action="UserController" method="post">
									<table align="center"  border="0" cellspacing="0" width="90%">
										...
										<caption><h1> Quick - Shop </h1></caption>
													...
													<td>
														...
														<table align="left" width="90%">
															...
															<tr>
																...
																<th id="reg" align="left" bgcolor="#CCCCCC" width="20%"><a href=""><label for="username"><fmt:message key="login.label.cover" /></label></a></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="12%"><a href="UserController?action=sortByCode"><label><fmt:message key="login.label.code" /></label></a></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="27%"><a href="UserController?action=sortByName"><label><fmt:message key="login.label.name" /></label></a></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="16%"><a href=""><label><fmt:message key="login.label.genre" /></label></a></th>
																<th id="reg" align="left" bgcolor="#CCCCCC" width="14%"><a href=""><label><fmt:message key="login.label.desc" /></label></a></th>
														...
														<form action="UserController" method="post">
															...
															<table frame="box" align="center" width="100%">
																...
																<tr>
																	...
																	<td id="reg" align="center"><a href="UserController?action=addtocart&code=<%=p.getCode()%>"><fmt:message key="login.button.addtocart" /></a></td>

										...
										<!--  action="UserController" method="post" name="myRegForm" ... onsubmit="return validateRegForm()"-->
											...
											<form action="UserController" method="post" name="myRegForm">
												...
												<table width="79%">
															...
															<tr><td colspan="4"><span style="color: red">* This User name is not Available, please try again !!! *</span></td></tr>
																	...
																	<form action="UserController" method="post">
																		<table width="100%">
																			<tr>
																				...
																				<td id="reg" align="left"><input type="hidden" name="action" value="check"></td>
																				<td id="reg" align="left"><input type="submit" value="<fmt:message key="login.button.avail" />"></td>

													...
													<td>
															...
															<table id="reg" frame="box" align="center" width="90%">
																...
																<tr>
																	...
																	<td id="reg" align="center" colspan="2"><label><span style="color: red"><fmt:message key="login.label.validate2" /></span></label></td>
																...
																<tr>
																	...
																	<td id="reg" ><input type="hidden" name="action" value=""></td>
																	<td id="reg" ><input type="button" value="<fmt:message key="login.button.update" />"></td>

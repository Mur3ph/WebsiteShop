/* SQL WITH CASCADE DATABASE ALL TABLES CREATE AS ONE BUT INSERT GROUPS HAVE TO BE DONE INDIVIDUALLY......................................*/
DROP TABLE REVIEW;
DROP TABLE TRACK;
...
CREATE TABLE THEORDER (
    ...
    CONSTRAINT fk_custid FOREIGN KEY (CUSTOMERID) REFERENCES CUSTOMER (CUSTOMERID) ON DELETE CASCADE
);	
...
CREATE TABLE NEWRELEASES(
	...
	CONSTRAINT fk_supplierid2 FOREIGN KEY (SUPPLIERID) REFERENCES THEBAND (SUPPLIERID) ON DELETE CASCADE
);
...
CREATE TABLE THEALBUMS(
	...
	CONSTRAINT fk_supplierid FOREIGN KEY (SUPPLIERID) REFERENCES THEBAND (SUPPLIERID) ON DELETE CASCADE
);
...
CREATE TABLE ORDERITEM(
    ...
    CONSTRAINT fk_orderid FOREIGN KEY (ORDERID) REFERENCES THEORDER (ORDERID) ON DELETE CASCADE,
	CONSTRAINT fk_productid FOREIGN KEY (PRODUCTID) REFERENCES THEALBUMS (PRODUCTID) ON DELETE CASCADE
);
...
CREATE TABLE TRACK(
	...
	CONSTRAINT fk_trackproductid FOREIGN KEY (PRODUCTID) REFERENCES THEALBUMS (PRODUCTID) ON DELETE CASCADE
);
...
CONSTRAINT fk_reviewalbumid FOREIGN KEY (PRODUCTID) REFERENCES THEALBUMS (PRODUCTID) ON DELETE CASCADE
);
...
INSERT INTO NEWRELEASES VALUES ( null, 1, 'images/new3.jpg', '1012X', 'HIPPIDY HOPP', 'Indie/Rock', 'Track 1 is Borneo by Firewater. Very neat shakin hips striding down the road drums a playin song. In your face great pseudo political lyrics and chorus. Love it. Usual Suspects by Ha Ha Tonka up next. Country Rock that rocks w/repeated song title chorus, cool band. Very nice. Harlem River Blues by Justin Townes Earle is track 3. This track was on the Bloodshot 2010 sampler, still sounds great, rock a billy-ish song bopping along. Next song is Intertwined by Maggie Bjorklund w/Mark Lanegan. Weird combination of 2 voices that do not seem to complement each other. Plodding bass behind voices. Eddie Spaghetti with Sundowner is next. Eddie races through speedy country number. I aint dancin this fast for any gurl.', 5.99);	
